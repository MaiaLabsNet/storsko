...
const ContactForm = () => {
  ...
  return (
    <section className="px-8 py-16 section-container" id="Contact">
      <DescriptionSection
      ...
      <div>
        <div className="relative flex flex-col bg-clip-border rounded-xl bg-[#0b0b0b] text-gray-700 shadow-md container mx-auto border border-gray-300">
